...
export default {
    ...
    data: () => ({
        ...
        links: [
            ...
            {text: 'Seguidores', icon: 'mdi-human-capacity-decrease', route: 'business.followers'},
            {text: "Seguidos", icon: 'mdi-human-capacity-increase', route: "business.followed"},
            {text: 'Estadísticas', icon: 'mdi-chart-bar', route: 'business.statistics'},
